...
Public Class Tampil_Struk
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Kelompok_3_Booking_Hotel.Tampil_Struk.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTampil_Struk
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Tampil_Struk = New Tampil_Struk()
        rpt.Site = Me.Site
        Return rpt
    End Function
